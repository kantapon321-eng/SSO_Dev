    ...
    <div class="col-lg-12 col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                <span class="h4">ประวัติคำขอ # {!! $applicationlab->application_no !!}</span>
                    ...
                    <div class="table-responsive">
                        <table class="table-bordered table table-hover primary-table" id="table-history">
                            ...
                            <tbody data-repeater-list="repeater-history" id="box_list_history">
                                ...
                                @php
                                    $accepts_history = $applicationlab->app_accept()->get();
                                @endphp
                                ...
                                @foreach($accepts_history as $key=> $item)
                                    <tr>
                                        ...
                                        <td>
                                            {{ ($item->application_status!='0' && $item->AppStatus)?$item->AppStatus:'ฉบับร่าง' }}
                                        </td>
                                        <td>
