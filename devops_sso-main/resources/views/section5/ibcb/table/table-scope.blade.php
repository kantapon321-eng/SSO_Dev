            ...
            <table class="table table-borderless" id="myTable">
                <thead>
                    <tr>
                        ...
                        <th width="1%" class="text-center">สาขา</th>
                        <th width="1%" class="text-center">รายสาขา</th>
                        <th width="1%" class="text-center">มอก.</th>
                        <th width="10%" class="text-center">รหัส</th>
                        <th width="15%" class="text-center">ชื่อผู้ตรวจสอบ</th>
                        <th width="5%" class="text-center">ชื่อย่อ</th>
                        <th width="12%" class="text-center">วันที่เป็นผู้ตรวจสอบ</th>
                        <th width="12%" class="text-center">วันที่สิ้นสุดผู้ตรวจสอบ</th>
                        <th width="10%" class="text-center">สถานะขอบข่าย</th>
                        <th width="19%" class="text-center">ข้อมูลติดต่อ</th>
                        <th width="10%" class="text-center">ประกาศ</th>
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#myTable').DataTable({
                ...
                searching: false,
                ajax: {
                    "url": '{!! url('/section5/data_ibcb_scope_list') !!}',
                    "dataType": "json",
                    "data": function (d) {
                ...
                columnDefs: [
                    { className: "text-top text-center", targets: [0,-1,-2,-4] },
                    { className: "text-center", visible: false, targets: [1,2,3] },
                ...
                fnDrawCallback: function() {
                    ...
                    api.column(3, {
                        page: 'current'
                    }).data().each(function(tis_tisno, i) {
                        if (std !== tis_tisno) {
                            $(rows).eq(i).before(
                                '<tr class="group"><td colspan="11">&nbsp;&nbsp;&nbsp;&nbsp;มอก. ' + tis_tisno + '</td></tr>'
                            );
                            std = tis_tisno;
                        }
                    });
