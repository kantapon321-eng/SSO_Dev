...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                <h3 class="box-title pull-left">คำขอขึ้นทะเบียนผู้ตรวจ และผู้ประเมินของผู้ตรวจสอบการทำผลิตภัณฑ์อุตสาหกรรม #{{ $applicationInspector->id }}</h3>
                ...
                <div id="box-readonly">
                    @include ('section5.application_inspectors.form', ['submitButtonText' => 'Update'])
                </div>
