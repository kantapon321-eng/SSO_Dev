...
class Sessions extends Model
{
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['id', 'user_id', 'ip_address', 'user_agent', 'login_at', 'last_visit_at', 'act_instead'];

    /*
      Sorting
    */
    public $sortable = ['id', 'user_id', 'ip_address', 'user_agent', 'login_at', 'last_visit_at', 'act_instead'];
    ...
    //บันทึก Session
    static function Add($session_id, $user_id, $ip_address, $user_agent, $channel = 'web', $act_instead = null, $app_name = null){
        ...
        $session->act_instead   = $act_instead;
        $session->save();
        ...
        $login_log->act_instead  = $act_instead;
