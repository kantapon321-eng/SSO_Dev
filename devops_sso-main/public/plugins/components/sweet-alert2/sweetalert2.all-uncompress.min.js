! function(t, e) {
    ...
    function et(t) {
        _e.isVisible() && it !== t.target.value && _e.resetValidationMessage(), it = t.target.value
    }
    ...
    function ot(t, e) {
        var n = Q(),
            o = K(),
            i = Z();
        e.showConfirmButton || e.showCancelButton || O(n), y(n, e.customClass, "actions"), pt(o, "confirm", e), pt(i, "cancel", e), e.buttonsStyling ? function(t, e, n) {
    ...
    function xt(t, i) {
        ...
        L(r), r.innerHTML = "";
        var a = parseInt(null === i.currentProgressStep ? _e.getQueueStep() : i.currentProgressStep);
    ...
    function Kt(t, e, n, o) {
        ...
        }), Ht.keydownHandlerAdded = !1), e.parentNode && e.parentNode.removeChild(e), G() && (null !== S.previousBodyPadding && (document.body.style.paddingRight = S.previousBodyPadding + "px", S.previousBodyPadding = null), function() {
    ...
    var Yt = function(t, e, n, o) {
            Ht.swalCloseEventFinishedCallback = Kt.bind(null, t, n, ut(), o), e.addEventListener(ft, function(t) {
    ...
    function oe(t) {
        var e = j(),
            n = R();
        "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n), pe(e, n, t), de(e, n), G() && fe(e, t.scrollbarPadding), ut() || Ht.previousActiveElement || (Ht.previousActiveElement = document.activeElement), "function" == typeof t.onOpen && setTimeout(function() {
            return t.onOpen(n)
        })
    }
    ...
    var de = function(t, e) {
            ft && H(e) ? (t.style.overflowY = "hidden", e.addEventListener(ft, ne.bind(null, e, t))) : t.style.overflowY = "auto"
        },
        fe = function(t, e) {
            ! function() {
                if (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream && !b(document.body, x.iosfix)) {
                    var t = document.body.scrollTop;
                    document.body.style.top = -1 * t + "px", rt(document.body, x.iosfix), Ft()
                }
        ...
        Se = ["Escape", "Esc"],
        Be = function(t, e, n, o) {
            n.stopKeydownPropagation && e.stopPropagation(), "Enter" === e.key ? Ae(t, e, n) : "Tab" === e.key ? Ee(e, n) : -1 !== Pe.indexOf(e.key) ? Te() : -1 !== Se.indexOf(e.key) && Le(e, n, o)
        },
        Ae = function(t, e, n) {
    ...
    var De, Ne = Object.freeze({
        ...
        _main: function(t) {
            ...
            return St(this, e), ht.innerParams.set(this, e),
                function(n, o, i) {
                    return new Promise(function(t) {
                        var e = function t(e) {
                            n.closePopup({
        ...
        update: function(e) {
            var n = {};
            Object.keys(e).forEach(function(t) {
                _e.isUpdatableParameter(t) ? n[t] = e[t] : w('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js'))
            });
    ...
    }), Ue.DismissReason = k, Ue.version = "8.15.2";
    var _e = Ue;
