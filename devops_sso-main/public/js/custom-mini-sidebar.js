$(function() {
    ...
    $(".sidebartoggler").on('click', function() {
        if ($("body").hasClass("mini-sidebar")) {
            ...
            $(".sidebartoggler i").removeClass("fa fa-bars");
            $(".logo span").hide();
            send_update_sidebar('mini-sidebar');
        }
    });

    var url_root = $('#theme').data('url');
    function send_update_sidebar(type_sidebar){
        $.ajax({
            method: "GET",
            url: url_root + "/user/update/type-sidebar/" + type_sidebar
        }).done(function(msg) {
    ...
    $(".right-side-toggler").on('click', function() {
        ...
        $(".fxhdr").on('click', function() {
            ...
            $.get(url_root + '/user/savefix-header/' + $(this).prop('checked'), function(data) {
                //console.log('success');
            });
        });
        ...
        $(".fxsdr").on('click', function() {
            ...
            $.get(url_root + '/user/savefix-sidebar/' + $(this).prop('checked'), function(data) {
               //console.log('success');
            });
        });
    });
